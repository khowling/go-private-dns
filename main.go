...
func main() {
	...
	p, err := NewAzureProvider(testDomain)
	if err != nil {
...
func NewAzureProvider(testDomainFilter string) (*AzureProvider, error) {
...
func (p *AzureProvider) privateZones() ([]privatedns.PrivateZone, error) {
...
func (p *AzureProvider) newRecordSet(endpoint *endpoint.Endpoint) (privatedns.RecordSet, error) {
...
func (p *AzureProvider) mapChanges(zones []privatedns.PrivateZone, changes *plan.Changes) (azureChangeMap, azureChangeMap) {
